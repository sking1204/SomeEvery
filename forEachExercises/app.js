...
//Version 2:
// const doubleValues2 = function (arr){
//     const newArr =[];
//     arr.forEach(num => {
//        newArr.push (num * 2 )
//     });
...
// const addKeyAndValue2 =(arr,key,value)=>{
//     arr.forEach(obj=>{
//         obj[key] =value;
//     })
//     return arr;
...
/*
5.Write a function called vowelCount which accepts a string and returns an object with the keys as the vowel and the values as the number of times the vowel appears in the string.
...
// //HOW CAN I CODE THIS CHECKING FOR AN EXACT MATCH TO THE KEY??
// function filterByValue(arr, key) {
//     return arr.filter(function(obj){
//         let keys =Object.keys(obj)
//         return arr.toString(keys) === key
...
//How can I show the index that corresponds to the result?????
